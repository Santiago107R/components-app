    ...
    <ThemeView margin>
      <ThemeCard>
        <SectionList
          ...
          ListHeaderComponent={() => (
            <ThemeText type='h1' className='font-bold mb-3'>Personajes</ThemeText>
          )}
          renderSectionHeader={({ section }) => (
            <ThemeText type='h1' className='bg-light-background my-2 dark:bg-dark-background p-2 rounded-md'>{section.title}</ThemeText>
          )}
          stickySectionHeadersEnabled

          ListFooterComponent={() => (
            <ThemeText type='h1' className='font-bold bg-light-background dark:bg-dark-background p-2 my-5 rounded'>Secciones: {houses.length}</ThemeText>
          )}
